            ...
            return (
                <>
                    <TextSettingItem
                        name={"API HOST"}
                        description={
                            "The HOST used in the requests."
                        }
                        placeholder={"127.0.0.1"}
                        value={settings.ollamaApiSettings.host}
                        errorMessage={errors.get("ollamaApiSettings.host")}
    ...
    return (
        <div>
            ...
            <TextSettingItem
                name={"Context Length"}
                description={
                    "This parameter adjusts the number of tokens that are sent to the model as context. A larger value will increase the context for the completion, but it will come at a cost to performance."
                }
                placeholder={"Your context length..."}
                value={settings.modelOptions.num_ctx.toString()}
                errorMessage={errors.get("modelOptions.num_ctx")}
                setValue={(value: string) =>
                    updateSettings({
                        modelOptions: {
                            ...settings.modelOptions,
                            num_ctx: parseInt(value),
                        },
                    })
                }
            />
